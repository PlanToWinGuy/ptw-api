...
// Section 5.0: per-pillar max Healthspan contribution, exactly as spec'd. Finances has no
// entry -- the spec's own cap table only lists six categories (Anti-Goals/Fitness/Diet/
// Relations/Work/Personal); Finances XP still counts toward total_lifetime_xp and leveling
// generally, it just doesn't independently move the Healthspan number the way these six do.
export const PILLAR_CAPS = { antiGoals: 10, fitness: 8, diet: 7, relations: 6, work: 5, personal: 4 };
