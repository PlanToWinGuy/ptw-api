...
const TOOL_HINT_RULES = {
  ...
  fitness: [[REVIEW_INTENT, 'fitness_review'], [/workout|exercise|train|lift|run|walk|stretch/i, 'workout']],
...
export async function findOpenSlot(sql, userId, { earliestDate, searchDays, durationMinutes, dayStartClock = '08:00', dayEndClock = '21:00', excludeTaskId = null }) {
