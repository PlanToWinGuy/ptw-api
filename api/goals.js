...
"dailyAnchor" already becomes its own real daily habit on its own -- never also repeat it (verbatim or reworded) as one of a phase's "actions". A phase's actions are the OTHER, supporting things that build toward the goal alongside the anchor, not the anchor itself again.`;
