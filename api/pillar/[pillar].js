...
const QUESTIONS = {
  Fitness: [
    ...
    { key: 'daily_time_budget', type: 'slider', q: 'On the days you work on this, how much time can you realistically dedicate per session? (minutes)', min: 15, max: 180 },
  ...
  Diet: [
    ...
    { key: 'time_of_day', type: 'single', q: 'What time of day works best for planning/prepping meals?', options: ['Morning', 'Midday', 'Evening', 'Flexible'] },
    { key: 'daily_time_budget', type: 'slider', q: 'On the days you work on this, how much time can you realistically dedicate per session? (minutes)', min: 15, max: 180 },
  ...
  Finances: [
    ...
    { key: 'time_of_day', type: 'single', q: 'What time of day works best for reviewing/managing your finances?', options: ['Morning', 'Midday', 'Evening', 'Flexible'] },
    { key: 'daily_time_budget', type: 'slider', q: 'On the days you work on this, how much time can you realistically dedicate per session? (minutes)', min: 15, max: 180 },
  ...
  Relations: [
    ...
    { key: 'time_of_day', type: 'single', q: 'What time of day works best for reaching out/connecting?', options: ['Morning', 'Midday', 'Evening', 'Flexible'] },
    { key: 'daily_time_budget', type: 'slider', q: 'On the days you work on this, how much time can you realistically dedicate per session? (minutes)', min: 15, max: 180 },
  ...
  Work: [
    ...
    { key: 'time_of_day', type: 'single', q: 'What time of day are you most productive for focused work?', options: ['Morning', 'Midday', 'Evening', 'Flexible'] },
    { key: 'daily_time_budget', type: 'slider', q: 'On the days you work on this, how much time can you realistically dedicate per session? (minutes)', min: 15, max: 180 },
