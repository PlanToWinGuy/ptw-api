...
const emails = ['projecttest-verify@plantowin.app', 'visiontest-verify@plantowin.app', 'logotest-verify@plantowin.app', 'notifchat-verify@plantowin.app', 'questtest-verify@plantowin.app', 'uifixtest-verify@plantowin.app'];
